...
public class SelectionSession extends JFrame implements RetourVue,SelectionVue {
    ...
    /**
     * Instantiates a new selection session.
     *
     * @param admin the admin
     */
    public SelectionSession(Administrateur admin) {
        // Create main frame
        super("JODES");
        this.admin = admin;
        setSize(800, 450);
        ...
        valider.addActionListener(new ControleurBtnSelectSession(this, combo, ControleurBtnSelectSession.MODIF, admin));
